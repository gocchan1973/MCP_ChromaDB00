...
def register_monitoring_tools(mcp: Any, db_manager: Any):
    ...
    def chroma_stats() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "status": "Failed to retrieve statistics"}
        ...
        try:
            ...
            tool_categories = {
                ...
                "HTML Learning & Web Content Processing": [
                    "bb7_bb8_chroma_store_html", "bb7_bb8_chroma_store_html_folder"
                ]
            }
            ...
            server_info = {
                ...
                "version": "2.0.0",
                "architecture": "Modular (8 categories)",
                ...
                "usage_examples": {
                    ...
                    "html_learning": "bb7_bb8_chroma_store_html"
                }
            }
